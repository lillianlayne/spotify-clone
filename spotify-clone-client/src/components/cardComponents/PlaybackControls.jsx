  ...
  return (
    <div className="w-full flex items-center">
      <div
        ...
        className="flex items-center justify-start flex-shrink-0 w-1/5"
      >
        <Shuffle
          className={
            shuffle
              ? "size-6 pointer-events-none text-green-600"
              : "size-6 text-translucent4 pointer-events-none"
          }
        />
      </div>
      ...
      <div
        ...
        className="flex items-center justify-end flex-shrink-0 w-1/5"
      >
        <Repeat
          className={
            repeat
